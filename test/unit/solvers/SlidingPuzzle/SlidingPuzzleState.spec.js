...
import { ERROR_MSG } from '../../../../dist/errors/constants';

describe('Sliding Puzzle', () => {
  describe('Sliding Puzzle State', () => {
    it('should throw an exception if an invalid puzzle is passed in', () => {
      const initPuzzle = [[1, 2, 3], [4, 5, 6], [7, 8, 9]];
      const ctor = () => new SlidingPuzzleState(initPuzzle);
      expect(ctor).to.throw(ERROR_MSG.SLIDING_PUZZLE_STATE_CONSTRUCTION_FAILURE);
    });
